...
void CGameContext::OnMessage(int MsgID, CUnpacker *pUnpacker, int ClientID)
{
	...
	else if (MsgID == NETMSGTYPE_CL_CHANGEINFO || MsgID == NETMSGTYPE_CL_STARTINFO)
	{
		...
		str_copy(pPlayer->start_name, Server()->ClientName(pPlayer->GetCID()), MAX_NAME_LENGTH);
...
void CGameContext::OnInit(/*class IKernel *pKernel*/)
{
	...
	// select gametype
	if(!str_comp(g_Config.m_SvGametype, "ctf") || !str_comp(g_Config.m_SvGametype, "CTF"))
	{
		m_pController = new CGameControllerCTF(this);
		m_pController->make_vanilla("CTF~");
		//m_pController->is_ctf = true;
	}
	else if(!str_comp(g_Config.m_SvGametype, "tdm") || !str_comp(g_Config.m_SvGametype, "TDM"))
	{
		m_pController = new CGameControllerTDM(this);
		m_pController->make_vanilla("TDM~");
		//m_pController->is_ctf = false;
	}
	else if(!str_comp(g_Config.m_SvGametype, "dm") || !str_comp(g_Config.m_SvGametype, "DM"))
	{
		m_pController = new CGameControllerDM(this);
		m_pController->make_vanilla("DM~");
		//m_pController->is_ctf = false;
	}
	else if(!str_comp(g_Config.m_SvGametype, "ictf") || !str_comp(g_Config.m_SvGametype, "ictf+") || !str_comp(g_Config.m_SvGametype, "iCTF") || !str_comp(g_Config.m_SvGametype, "iCTF+"))
	{
		m_pController = new CGameControllerCTF(this);
		m_pController->make_instagib("iCTF~");
		//m_pController->is_ctf = true;
	}
	else if(!str_comp(g_Config.m_SvGametype, "itdm") || !str_comp(g_Config.m_SvGametype, "itdm+") || !str_comp(g_Config.m_SvGametype, "iTDM") || !str_comp(g_Config.m_SvGametype, "iTDM+"))
	{
		m_pController = new CGameControllerTDM(this);
		m_pController->make_instagib("iTDM~");
		//m_pController->is_ctf = false;
	}
	else if(!str_comp(g_Config.m_SvGametype, "idm") || !str_comp(g_Config.m_SvGametype, "idm+") || !str_comp(g_Config.m_SvGametype, "iDM") || !str_comp(g_Config.m_SvGametype, "iDM+"))
	{
		m_pController = new CGameControllerDM(this);
		m_pController->make_instagib("iDM~");
		//m_pController->is_ctf = false;
	}
